...
GLOBAL_CACHE_DIR = os.path.join(GLOBAL_CK_DIR, "cache")
GLOBAL_TOOLCHAINS_DIR = os.path.join(GLOBAL_CK_DIR, "toolchains")
GLOBAL_TOOLCHAIN_FILE = os.path.join(GLOBAL_CK_DIR, "toolchain")
...
LOCAL_TOOLCHAIN_FILE = os.path.join(PROJECT_CK_DIR, "toolchain")
SRC_DIR = "src"
META_DIR = "meta"
